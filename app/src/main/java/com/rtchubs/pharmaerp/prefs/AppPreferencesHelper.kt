...
import com.rtchubs.pharmaerp.di.PreferenceInfo
...
class AppPreferencesHelper @Inject constructor(
    ...
    override var isUpdatingLocation by BooleanPreference(prefs, KEY_IS_UPDATING_LOCATION, defaultValue = false, commit = true)
    ...
    override fun saveUser(user: PharmaUser) {
        val userString = Gson().toJson(user)
        prefs.value.edit {
            putString(KEY_LOGGED_USER, userString)
        }
    }

    override fun getUser(): PharmaUser {
        val userString = prefs.value.getString(KEY_LOGGED_USER, "{}")
        return Gson().fromJson(userString, PharmaUser::class.java)
    }
...
// ...then create a OneTimeWorkRequest that uses those constraints
    ...
    companion object {
        ...
        private const val KEY_IS_UPDATING_LOCATION = "IsUpdatingLocation"
        ...
        private const val KEY_LOGGED_USER = "KEY_LOGGED_USER"
